...
public class OperationsPanel extends JPanel {
	...
	private JComboBox<OperationOnSignals> operations;
	...
	private void initialize(){
		...
		operations = new JComboBox<OperationOnSignals>();
	...
	public JComboBox<OperationOnSignals> getOperations() {
		return operations;
	}
	...
	public ChartPanel getSecondSignalPrevPanel() {
		return panelSecondSignalPrev;
	}

	public ChartPanel getFirstSignalPrevPanel() {
