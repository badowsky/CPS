...
public class Graph {
	...
	public static JFreeChart drawComplexGraphW1RealPart(Complex[] y, boolean connected) {
		...
		if (connected) {
			chart = ChartFactory.createXYLineChart("Część rzeczywista", // Title
					"Numer próbki", // x-axis Label
					"Wartość rzeczywista", // y-axis Label
					dataset, // Dataset
			...
			chart = ChartFactory.createScatterPlot("Część rzeczywista", // Title
					"Numer próbki", // x-axis Label
					"Wartość rzeczywista", // y-axis Label
					dataset, // Dataset
					PlotOrientation.VERTICAL, // Plot Orientation
	...
	public static JFreeChart drawComplexGraphW1ImagPart(Complex[] y, boolean connected) {
		...
		JFreeChart chart = null;
		if (connected) {
			chart = ChartFactory.createXYLineChart("Część urojona", // Title
					"Numer próbki", // x-axis Label
					"Wartość urojona", // y-axis Label
					dataset, // Dataset
					PlotOrientation.VERTICAL, // Plot Orientation
					dataset.getSeriesCount() > 1, // Show Legend
					true, // Use tooltips
			...
			chart = ChartFactory.createScatterPlot("Część urojona", // Title
					"Numer próbki", // x-axis Label
					"Wartość urojona", // y-axis Label
					dataset, // Dataset
					PlotOrientation.VERTICAL, // Plot Orientation
	...
	public static JFreeChart drawComplexGraphW2ModulePart(Complex[] y, boolean connected) {
		...
		JFreeChart chart = null;
		if (connected) {
			chart = ChartFactory.createXYLineChart("Moduł", // Title
					"Numer próbki", // x-axis Label
					"Wartość modułu", // y-axis Label
					dataset, // Dataset
					PlotOrientation.VERTICAL, // Plot Orientation
					dataset.getSeriesCount() > 1, // Show Legend
					true, // Use tooltips
			...
			chart = ChartFactory.createScatterPlot("Moduł", // Title
					"Numer próbki", // x-axis Label
					"Wartość modułu", // y-axis Label
					dataset, // Dataset
					PlotOrientation.VERTICAL, // Plot Orientation
	...
	public static JFreeChart drawComplexGraphW2ArgumentPart(Complex[] y, boolean connected) {
		...
		if (connected) {
			chart = ChartFactory.createXYLineChart("Argument", // Title
					"Numer próbki", // x-axis Label
					"Wartość argumentu", // y-axis Label
					dataset, // Dataset
					PlotOrientation.VERTICAL, // Plot Orientation
					dataset.getSeriesCount() > 1, // Show Legend
					true, // Use tooltips
