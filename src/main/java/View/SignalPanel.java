...
public class SignalPanel extends JPanel {
	...
	private JComboBox<ContinuousSignal> signalChooser;
	...
	private SignalParamsPanel generatedParamsPanel;
	private MyCallable<JFreeChart> onChartChange;

	private static int NUMBER_OF_PARAMS = 6;
	private static String[] DEFAULT_PARAMS_VALUES = { "10", "0", "3", "10", "5", "0.3" };
	...
	private void initialize() {
		...
		signalChooser = new JComboBox<ContinuousSignal>();
		...
		for (int i = 0; i < SignalPanel.NUMBER_OF_PARAMS; i++) {
		...
		for (int i = 0; i < SignalPanel.NUMBER_OF_PARAMS; i++) {
			tmpParamTF = new JTextField(SignalPanel.DEFAULT_PARAMS_VALUES[i]);
	...
	public JComboBox<ContinuousSignal> getSignalChooser() {
	...
	public SignalParamsPanel getGeneratedParamsPanel() {
		return generatedParamsPanel;
	}
}
